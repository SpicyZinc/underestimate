...
public class EditDistanceRecursive {
	public int minDistance(String word1, String word2) {
		private HashMap<String, Integer> editMemo = new HashMap<String, Integer>();
		return helper(word1, 0, word2, 0, editMemo);
	}

	private int helper(String word1, int i, String word2, int j, HashMap<String, Integer> editMemo) {  
