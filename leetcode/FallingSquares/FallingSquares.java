...
idea:
1. direct thought, deal with one falling square by one
2. HashMap, no implementation
https://www.cnblogs.com/grandyang/p/8486414.html
*/
...
class FallingSquares {
	public List<Integer> fallingSquares(int[][] positions) {
		...
		for (int[] position : positions) {
			...
			int height = sideLength + baseHeight;
