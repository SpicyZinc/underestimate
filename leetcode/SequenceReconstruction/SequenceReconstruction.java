/*
	it is sufficient to just check if every two adjacent elements also appears adjacently in the sub-sequences. (some basic boundary checking is also necessary)
*/
