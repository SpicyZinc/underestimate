...
idea:
list of 2-element array to keep all reservation intervals
for any new reservation, check if it conflicts with all existing reservations
how? max(s, start) < min(e, end)
*/
