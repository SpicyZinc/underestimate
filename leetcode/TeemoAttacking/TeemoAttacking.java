...
idea:
good perspective: same idea as merge interval

direct thought and implement it
loop through the array
treat two cases differently
1. duration greater than the gap between two consecutive elements
2. duration less than the gap between two consecutive elements
*/
